...
<head>
    ...
    <meta name="author" content="Gilang Fajriansyah"/>
    <!-- bootstrap 3.0.2 -->
...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di PrimeLibrary (Perpustakaan Berbasis Website) Free Version, Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
                    ...
                    <div class="twt-area">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk PrimeLibrary" cols="25"></textarea>
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
...
<!-- Data Total Pengunjung -->                        
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="#" target="_blank">PrimeLibrary</a> 2018
                </div>
            </aside><!-- /.right-side -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">PrimeLibrary Info</h4>
      </div>
      <div class="modal-body">
      PrimeLibrary adalah aplikasi perpustakaan bebasis website yang responsif, yang memudahkan pustakawan untuk melihat data dan mengaturnya secara efisien.
      <table>
      <tr>
      <td>E-mail</td><td>:</td> <td><a href="gilangfajriansyah@gmail.com">gilangfajriansyah@gmail.com</a></td>
      </tr> 
      <br />
      <tr>
       </table>
